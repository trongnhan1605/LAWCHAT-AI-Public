...
class AuthorityLevelDefinition(Base):
    __tablename__ = "authority_level_definitions"
    ...
    hierarchy_rank: Mapped[int] = mapped_column(Integer, nullable=False, default=999)
